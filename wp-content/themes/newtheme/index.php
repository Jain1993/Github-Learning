...
//echo "yes";echo $custom_logo_id;die;
...
?>
	...
	<div class="banner">
		<div class="effect5"><!--shadow effect-->
			<div class="container">
				<div class="logo">
					<h1><a href="index.html"><img src="<?php echo $img;?>" alt="" /></a></h1>
				</div>
  ...
  wp_nav_menu(array(
      'menu'=>'primary-menu',
      'container'=>'',
      'item_wrap'=>'<ul class="nav navbar-nav navbar-center"></ul>', 
    )); 
?>
			...
			<div class="welcome-info">
				<div class="col-md-6 welcome-grids">
					<div class="welcome-img">
						<img src="<?php echo get_template_directory_uri().'/images/img1.jpg';?>" class="img-responsive zoom-img" alt=""/>
					</div>
				</div>
				<div class="col-md-6 welcome-grids">
					<div class="welcome-img">
						<img src="<?php echo get_template_directory_uri().'/images/img2.jpg';?>" class="img-responsive zoom-img" alt=""/>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
	...
	<div class="popular">
		<div class="container">
			...
			<div class="col-md-4 popular-grids popular-img">
				<img src="<?php echo get_template_directory_uri().'/images/img3.jpg';?>" class="img-responsive zoom-img" alt=""/>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
	...
	<div class="footer">
		<div class="footer-info">
			<div class="container">	
				<div class="icons">	
					<ul>
						<li><a href="#" data-toggle="tooltip" data-placement="top" title="Facebook"><img src="<?php echo get_template_directory_uri().'/images/i1.png';?>" alt=""/></a></li>
						<li><a href="#" data-toggle="tooltip" data-placement="top" title="Twitter"><img src="<?php echo get_template_directory_uri().'/images/i2.png';?>" alt=""/> </a></li>
						<li><a href="#" data-toggle="tooltip" data-placement="top" title="Google+"><img src="<?php echo get_template_directory_uri().'/images/i3.png';?>" alt=""/></a></li>
						<li><a href="#" data-toggle="tooltip" data-placement="top" title="LinkedIn"><img src="<?php echo get_template_directory_uri().'/images/i4.png';?>" alt=""/> </a></li>
						<li><a href="#" data-toggle="tooltip" data-placement="top" title="Pinterest"><img src="<?php echo get_template_directory_uri().'/images/i5.png';?>" alt=""/> </a></li>
					</ul>
					<script>$(function () {
